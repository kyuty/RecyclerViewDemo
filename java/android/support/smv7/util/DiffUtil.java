...
public class DiffUtil {
     ...
     * {@link #dispatchUpdatesTo(android.support.smv7.util.ListUpdateCallback)} or directly stream the results into a
    ...
    public static class DiffResult {
         ...
         * {@link RecyclerView.AdapterDataObserver AdapterDataObserver},
         * you can use
         * {@link #dispatchUpdatesTo(android.support.smv7.util.ListUpdateCallback)} to handle each modification
         * manually.
         *
        ...
        public void dispatchUpdatesTo(final RecyclerView.Adapter adapter) {
            dispatchUpdatesTo(new android.support.smv7.util.ListUpdateCallback() {
                @Override
         ...
         */
        public void dispatchUpdatesTo(android.support.smv7.util.ListUpdateCallback updateCallback) {
            final android.support.smv7.util.BatchingListUpdateCallback batchingCallback;
            if (updateCallback instanceof android.support.smv7.util.BatchingListUpdateCallback) {
                batchingCallback = (android.support.smv7.util.BatchingListUpdateCallback) updateCallback;
            } else {
        ...
        private void dispatchAdditions(List<PostponedUpdate> postponedUpdates,
                                       android.support.smv7.util.ListUpdateCallback updateCallback, int start, int count, int globalIndex) {
            if (!mDetectMoves) {
