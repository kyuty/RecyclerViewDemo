 ...
 * decorations.
 *
 * @see #createHorizontalHelper(android.support.smv7.widget.RecyclerView.LayoutManager)
 * @see #createVerticalHelper(android.support.smv7.widget.RecyclerView.LayoutManager)
 */
public abstract class OrientationHelper {

    private static final int INVALID_SIZE = Integer.MIN_VALUE;

    protected final android.support.smv7.widget.RecyclerView.LayoutManager mLayoutManager;
    ...
    private OrientationHelper(android.support.smv7.widget.RecyclerView.LayoutManager layoutManager) {
     ...
     * {@link android.support.smv7.widget.RecyclerView.LayoutManager#onLayoutChildren(android.support.smv7.widget.RecyclerView.Recycler,
     * android.support.smv7.widget.RecyclerView.State)} method.
     *
     ...
     * its position
     *
     * @see android.support.smv7.widget.RecyclerView.LayoutManager#getTransformedBoundingBox(View, boolean, Rect)
     */
     ...
     * @see android.support.smv7.widget.RecyclerView.LayoutManager#getWidthMode()
     * @see android.support.smv7.widget.RecyclerView.LayoutManager#getHeightMode()
     */
    ...
    public static OrientationHelper createOrientationHelper(
            android.support.smv7.widget.RecyclerView.LayoutManager layoutManager, int orientation) {
        switch (orientation) {
            case HORIZONTAL:
    ...
    public static OrientationHelper createHorizontalHelper(
            android.support.smv7.widget.RecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) {
            ...
            public int getDecoratedMeasurement(View view) {
                final android.support.smv7.widget.RecyclerView.LayoutParams params = (android.support.smv7.widget.RecyclerView.LayoutParams)
     ...
     * @return A new OrientationHelper
     */
    public static OrientationHelper createVerticalHelper(android.support.smv7.widget.RecyclerView.LayoutManager layoutManager) {
        return new OrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
            ...
            @Override
            public int getDecoratedStart(View view) {
                final android.support.smv7.widget.RecyclerView.LayoutParams params = (RecyclerView.LayoutParams)
                        view.getLayoutParams();
