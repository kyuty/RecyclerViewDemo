...
import static android.support.smv7.widget.RecyclerView.NO_POSITION;
...
import android.support.smv7.widget.RecyclerView.LayoutParams;
...
/**
 * A {@link android.support.smv7.widget.RecyclerView.LayoutManager} implementation which provides
 * similar functionality to {@link android.widget.ListView}.
 */
public class LinearLayoutManager extends android.support.smv7.widget.RecyclerView.LayoutManager implements
        ItemTouchHelper.ViewDropHandler, android.support.smv7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider {

    private static final String TAG = "LinearLayoutManager";

    static final boolean DEBUG = false;

    public static final int HORIZONTAL = android.support.smv7.widget.OrientationHelper.HORIZONTAL;

    public static final int VERTICAL = android.support.smv7.widget.OrientationHelper.VERTICAL;
     ...
     */
    android.support.smv7.widget.OrientationHelper mOrientationHelper;
     ...
     * {@link #onLayoutChildren(android.support.smv7.widget.RecyclerView.Recycler, android.support.smv7.widget.RecyclerView.State)} is run.
     */
    ...
    * */
     ...
     *
     * @attr ref android.support.smv7.recyclerview.R.styleable#RecyclerView_android_orientation
     * @attr ref android.support.smv7.recyclerview.R.styleable#RecyclerView_reverseLayout
     * @attr ref android.support.smv7.recyclerview.R.styleable#RecyclerView_stackFromEnd
     */
     ...
     * RecyclerView.
     * <p>
     * If you are using a {@link android.support.smv7.widget.RecyclerView.RecycledViewPool}, it might be a good idea to set
    ...
    @Override
    public void onDetachedFromWindow(android.support.smv7.widget.RecyclerView view, android.support.smv7.widget.RecyclerView.Recycler recycler) {
     ...
     * When set to true, If {@link android.support.smv7.widget.RecyclerView} is LTR, than it will
     * layout from RTL, if {@link android.support.smv7.widget.RecyclerView}} is RTL, it will layout
     * from LTR.
     *
     ...
     */
    protected int getExtraLayoutSpace(android.support.smv7.widget.RecyclerView.State state) {
    ...
    @Override
    public void smoothScrollToPosition(android.support.smv7.widget.RecyclerView recyclerView, android.support.smv7.widget.RecyclerView.State state,
                                       int position) {
     ...
     */
    @Override
    public void onLayoutChildren(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state) {
        // layout algorithm:
    ...
    @Override
    public void onLayoutCompleted(android.support.smv7.widget.RecyclerView.State state) {
     ...
     *                                 indices.
     */
    void onAnchorReady(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
     ...
     */
    private void layoutForPredictiveAnimations(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                               android.support.smv7.widget.RecyclerView.State state, int startOffset, int endOffset) {
        ...
        final List<android.support.smv7.widget.RecyclerView.ViewHolder> scrapList = recycler.getScrapList();
        final int scrapSize = scrapList.size();
        final int firstChildPos = getPosition(getChildAt(0));
        for (int i = 0; i < scrapSize; i++) {
            android.support.smv7.widget.RecyclerView.ViewHolder scrap = scrapList.get(i);
            if (scrap.isRemoved()) {
                continue;
            }
    ...
    private void updateAnchorInfoForLayout(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
     ...
     */
    private boolean updateAnchorFromChildren(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                             android.support.smv7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (getChildCount() == 0) {
            return false;
        }
     ...
     */
    private boolean updateAnchorFromPendingData(android.support.smv7.widget.RecyclerView.State state, AnchorInfo anchorInfo) {
        if (state.isPreLayout() || mPendingScrollPosition == NO_POSITION) {
            return false;
        }
     ...
     */
    private int fixLayoutEndGap(int endOffset, android.support.smv7.widget.RecyclerView.Recycler recycler,
                                android.support.smv7.widget.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     * @return The final offset amount for children
     */
    private int fixLayoutStartGap(int startOffset, android.support.smv7.widget.RecyclerView.Recycler recycler,
                                  android.support.smv7.widget.RecyclerView.State state, boolean canOffsetChildren) {
     ...
     */
    @Override
    public int scrollHorizontallyBy(int dx, android.support.smv7.widget.RecyclerView.Recycler recycler,
            android.support.smv7.widget.RecyclerView.State state) {
     ...
     */
    @Override
    public int scrollVerticallyBy(int dy, android.support.smv7.widget.RecyclerView.Recycler recycler,
            android.support.smv7.widget.RecyclerView.State state) {
        if (mOrientation == HORIZONTAL) {
            return 0;
        }
    ...
    @Override
    public int computeHorizontalScrollOffset(android.support.smv7.widget.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    @Override
    public int computeVerticalScrollOffset(android.support.smv7.widget.RecyclerView.State state) {
        return computeScrollOffset(state);
    }

    @Override
    public int computeHorizontalScrollExtent(android.support.smv7.widget.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    @Override
    public int computeVerticalScrollExtent(android.support.smv7.widget.RecyclerView.State state) {
        return computeScrollExtent(state);
    }

    @Override
    public int computeHorizontalScrollRange(android.support.smv7.widget.RecyclerView.State state) {
        return computeScrollRange(state);
    }

    @Override
    public int computeVerticalScrollRange(android.support.smv7.widget.RecyclerView.State state) {
        return computeScrollRange(state);
    }

    private int computeScrollOffset(android.support.smv7.widget.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
        return android.support.smv7.widget.ScrollbarHelper.computeScrollOffset(state, mOrientationHelper,
    ...
    private int computeScrollExtent(android.support.smv7.widget.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
        return android.support.smv7.widget.ScrollbarHelper.computeScrollExtent(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
                this,  mSmoothScrollbarEnabled);
    }

    private int computeScrollRange(android.support.smv7.widget.RecyclerView.State state) {
        if (getChildCount() == 0) {
            return 0;
        }
        ensureLayoutState();
        return android.support.smv7.widget.ScrollbarHelper.computeScrollRange(state, mOrientationHelper,
                findFirstVisibleChildClosestToStart(!mSmoothScrollbarEnabled, true),
                findFirstVisibleChildClosestToEnd(!mSmoothScrollbarEnabled, true),
                this, mSmoothScrollbarEnabled);
    }
     ...
     */
    private void recycleChildren(android.support.smv7.widget.RecyclerView.Recycler recycler, int startIndex, int endIndex) {
     ...
     *
     * @param recycler Recycler instance of {@link android.support.smv7.widget.RecyclerView}
     * @param dt       This can be used to add additional padding to the visible area. This is used
     *                 to detect children that will go out of bounds after scrolling, without
     *                 actually moving them.
     */
    private void recycleViewsFromStart(android.support.smv7.widget.RecyclerView.Recycler recycler, int dt) {
        if (dt < 0) {
            if (DEBUG) {
     ...
     *                 actually moving them.
     */
    private void recycleViewsFromEnd(android.support.smv7.widget.RecyclerView.Recycler recycler, int dt) {
        final int childCount = getChildCount();
        if (dt < 0) {
            if (DEBUG) {
     ...
     * @see #recycleViewsFromStart(android.support.smv7.widget.RecyclerView.Recycler, int)
     * @see #recycleViewsFromEnd(android.support.smv7.widget.RecyclerView.Recycler, int)
     * @see LinearLayoutManager.LayoutState#mLayoutDirection
     */
    private void recycleByLayoutState(android.support.smv7.widget.RecyclerView.Recycler recycler, LayoutState layoutState) {
     ...
     */
    int fill(android.support.smv7.widget.RecyclerView.Recycler recycler, LayoutState layoutState,
             android.support.smv7.widget.RecyclerView.State state, boolean stopOnFocusable) {
    ...
    void layoutChunk(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
     ...
     */
    private View findReferenceChildClosestToEnd(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                                android.support.smv7.widget.RecyclerView.State state) {
     ...
     * @return A View that can be used an an anchor View.
     */
    private View findReferenceChildClosestToStart(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                                  android.support.smv7.widget.RecyclerView.State state) {
        return mShouldReverseLayout ? findLastReferenceChild(recycler, state) :
                findFirstReferenceChild(recycler, state);
    }

    private View findFirstReferenceChild(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state) {
        return findReferenceChild(recycler, state, 0, getChildCount(), state.getItemCount());
    }

    private View findLastReferenceChild(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state) {
        return findReferenceChild(recycler, state, getChildCount() - 1, -1, state.getItemCount());
    }

    // overridden by GridLayoutManager
    View findReferenceChild(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
     ...
     *
     * @return The adapter position of the first visible item or {@link android.support.smv7.widget.RecyclerView#NO_POSITION} if
     ...
     * {@link android.support.smv7.widget.RecyclerView#NO_POSITION} if there aren't any visible items.
     ...
     * are ignored in this method.
     *
     * @return The adapter position of the last visible view or {@link android.support.smv7.widget.RecyclerView#NO_POSITION} if
     * there aren't any visible items.
     * @see #findLastCompletelyVisibleItemPosition()
     * @see #findFirstVisibleItemPosition()
     */
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
                                    android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state) {
        resolveShouldLayoutReverse();
        if (getChildCount() == 0) {
            return null;
        }
    ...
    static class LayoutState {
        ...
        /**
         * Equal to {@link android.support.smv7.widget.RecyclerView.State#isPreLayout()}. When consuming scrap, if this value
        ...
        /**
         * The most recent {@link #scrollBy(int, android.support.smv7.widget.RecyclerView.Recycler, android.support.smv7.widget.RecyclerView.State)}
         * amount.
         */
         ...
         */
        List<android.support.smv7.widget.RecyclerView.ViewHolder> mScrapList = null;
         ...
         */
        boolean hasMore(android.support.smv7.widget.RecyclerView.State state) {
         ...
         */
        View next(android.support.smv7.widget.RecyclerView.Recycler recycler) {
            if (mScrapList != null) {
