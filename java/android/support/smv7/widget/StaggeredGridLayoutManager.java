...
import static android.support.smv7.widget.LayoutState.ITEM_DIRECTION_HEAD;
import static android.support.smv7.widget.LayoutState.ITEM_DIRECTION_TAIL;
import static android.support.smv7.widget.LayoutState.LAYOUT_END;
import static android.support.smv7.widget.LayoutState.LAYOUT_START;
...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements
    ...
    private void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state,
        ...
        if (!anchorInfo.mValid || mPendingScrollPosition != RecyclerView.NO_POSITION ||
