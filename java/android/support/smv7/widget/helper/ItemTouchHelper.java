...
package android.support.smv7.widget.helper;
...
import android.support.smv7.widget.RecyclerView.OnItemTouchListener;
...
public class ItemTouchHelper extends RecyclerView.ItemDecoration
    ...
    public abstract static class Callback {
        ...
        private static final android.support.smv7.widget.helper.ItemTouchUIUtil sUICallback;
        ...
        static {
            if (Build.VERSION.SDK_INT >= 21) {
                sUICallback = new android.support.smv7.widget.helper.ItemTouchUIUtilImpl.Lollipop();
            } else if (Build.VERSION.SDK_INT >= 11) {
                sUICallback = new android.support.smv7.widget.helper.ItemTouchUIUtilImpl.Honeycomb();
            } else {
                sUICallback = new android.support.smv7.widget.helper.ItemTouchUIUtilImpl.Gingerbread();
            }
        }

        /**
         * Returns the {@link android.support.smv7.widget.helper.ItemTouchUIUtil} that is used by the {@link Callback} class for
         * visual
         * changes on Views in response to user interactions. {@link android.support.smv7.widget.helper.ItemTouchUIUtil} has different
         ...
         * </pre>
         *
         * @return The {@link android.support.smv7.widget.helper.ItemTouchUIUtil} instance that is used by the {@link Callback}
         */
    ...
    public abstract static class SimpleCallback extends Callback {
        ...
        public int getMovementFlags(RecyclerView recyclerView, ViewHolder viewHolder) {
            return android.support.smv7.widget.helper.ItemTouchHelper.Callback.makeMovementFlags(getDragDirs(recyclerView, viewHolder),
