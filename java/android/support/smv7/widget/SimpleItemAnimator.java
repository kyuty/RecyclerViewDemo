...
import android.support.smv7.widget.RecyclerView.Adapter;
import android.support.smv7.widget.RecyclerView.ViewHolder;
 ...
 * API.
 * <p>
 * It uses {@link android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo} to track the bounds information of the Views. If you would like
 * to
 * extend this class, you can override {@link #obtainHolderInfo()} method to provide your own info
 * class that extends {@link android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo}.
 */
abstract public class SimpleItemAnimator extends RecyclerView.ItemAnimator {
    ...
    public boolean animateDisappearance(@NonNull ViewHolder viewHolder,
                                        @NonNull android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @Nullable android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
    ...
    public boolean animateAppearance(@NonNull ViewHolder viewHolder,
                                     @Nullable android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preLayoutInfo, @NonNull android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postLayoutInfo) {
    ...
    public boolean animatePersistence(@NonNull ViewHolder viewHolder,
                                      @NonNull android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo preInfo, @NonNull android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo postInfo) {
     ...
     * @see RecyclerView.ItemAnimator#animateDisappearance(ViewHolder, android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo,
     * android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
     */
     ...
     * @see RecyclerView.ItemAnimator#animateDisappearance(ViewHolder, android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo,
     * android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
     * @see RecyclerView.ItemAnimator#animatePersistence(ViewHolder, android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo, android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
     * @see RecyclerView.ItemAnimator#animateAppearance(ViewHolder, android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo, android.support.smv7.widget.RecyclerView.ItemAnimator.ItemHolderInfo)
     */
