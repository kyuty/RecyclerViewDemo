...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
     ...
     */
    @Override
    protected void onTargetFound(View targetView, RecyclerView.State state, android.support.smv7.widget.RecyclerView.SmoothScroller.Action action) {
     ...
     */
    @Override
    protected void onSeekTargetStep(int dx, int dy, RecyclerView.State state, android.support.smv7.widget.RecyclerView.SmoothScroller.Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
     ...
     */
    protected void updateActionForInterimTarget(android.support.smv7.widget.RecyclerView.SmoothScroller.Action action) {
    ...
    public PointF computeScrollVectorForPosition(int targetPosition) {
        ...
        if (layoutManager instanceof android.support.smv7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider) {
            return ((android.support.smv7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider) layoutManager)
                    .computeScrollVectorForPosition(targetPosition);
        }
        Log.w(TAG, "You should override computeScrollVectorForPosition when the LayoutManager" +
                " does not implement " + android.support.smv7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider.class.getCanonicalName());
        return null;
    }
}
