...
/**
 * A {@link android.support.smv7.widget.RecyclerView.LayoutManager} implementations that lays out items in a grid.
 * <p>
...
public class GridLayoutManager extends LinearLayoutManager {
     ...
     * single column.
     *
     * @attr ref android.support.smv7.recyclerview.R.styleable#RecyclerView_spanCount
     */
    public GridLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                             int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        android.support.smv7.widget.RecyclerView.LayoutManager.Properties properties = android.support.smv7.widget.RecyclerView.LayoutManager.getProperties(context, attrs, defStyleAttr, defStyleRes);
    ...
    @Override
    public int getRowCountForAccessibility(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                           android.support.smv7.widget.RecyclerView.State state) {
        if (mOrientation == android.support.smv7.widget.LinearLayoutManager.HORIZONTAL) {
            return mSpanCount;
        }
    ...
    @Override
    public int getColumnCountForAccessibility(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                              android.support.smv7.widget.RecyclerView.State state) {
        if (mOrientation == android.support.smv7.widget.LinearLayoutManager.VERTICAL) {
            return mSpanCount;
        }
        if (state.getItemCount() < 1) {
            return 0;
    ...
    @Override
    public void onInitializeAccessibilityNodeInfoForItem(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                                         android.support.smv7.widget.RecyclerView.State state, View host, AccessibilityNodeInfoCompat info) {
    ...
    @Override
    public void onItemsAdded(android.support.smv7.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsChanged(android.support.smv7.widget.RecyclerView recyclerView) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsRemoved(android.support.smv7.widget.RecyclerView recyclerView, int positionStart, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsUpdated(android.support.smv7.widget.RecyclerView recyclerView, int positionStart, int itemCount,
                               Object payload) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public void onItemsMoved(android.support.smv7.widget.RecyclerView recyclerView, int from, int to, int itemCount) {
        mSpanSizeLookup.invalidateSpanIndexCache();
    }

    @Override
    public android.support.smv7.widget.RecyclerView.LayoutParams generateDefaultLayoutParams() {
        if (mOrientation == android.support.smv7.widget.LinearLayoutManager.HORIZONTAL) {
    ...
    @Override
    public android.support.smv7.widget.RecyclerView.LayoutParams generateLayoutParams(Context c, AttributeSet attrs) {
        return new LayoutParams(c, attrs);
    }

    @Override
    public android.support.smv7.widget.RecyclerView.LayoutParams generateLayoutParams(ViewGroup.LayoutParams lp) {
    ...
    @Override
    public boolean checkLayoutParams(android.support.smv7.widget.RecyclerView.LayoutParams lp) {
    ...
    private void updateMeasurements() {
        int totalSpace;
        if (getOrientation() == android.support.smv7.widget.LinearLayoutManager.VERTICAL) {
    ...
    public void setMeasuredDimension(Rect childrenBounds, int wSpec, int hSpec) {
        ...
        if (mOrientation == android.support.smv7.widget.LinearLayoutManager.VERTICAL) {
            ...
            height = android.support.smv7.widget.RecyclerView.LayoutManager.chooseSize(hSpec, usedHeight, getMinimumHeight());
            width = android.support.smv7.widget.RecyclerView.LayoutManager.chooseSize(wSpec, mCachedBorders[mCachedBorders.length - 1] + horizontalPadding,
                    getMinimumWidth());
        } else {
            final int usedWidth = childrenBounds.width() + horizontalPadding;
            width = android.support.smv7.widget.RecyclerView.LayoutManager.chooseSize(wSpec, usedWidth, getMinimumWidth());
            height = android.support.smv7.widget.RecyclerView.LayoutManager.chooseSize(hSpec, mCachedBorders[mCachedBorders.length - 1] + verticalPadding,
                    getMinimumHeight());
        }
    ...
    int getSpaceForSpanRange(int startSpan, int spanSize) {
        if (mOrientation == android.support.smv7.widget.LinearLayoutManager.VERTICAL && isLayoutRTL()) {
    ...
    void onAnchorReady(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
                       android.support.smv7.widget.LinearLayoutManager.AnchorInfo anchorInfo, int itemDirection) {
    ...
    private void ensureAnchorIsInCorrectSpan(android.support.smv7.widget.RecyclerView.Recycler recycler,
                                             android.support.smv7.widget.RecyclerView.State state, android.support.smv7.widget.LinearLayoutManager.AnchorInfo anchorInfo, int itemDirection) {
        final boolean layingOutInPrimaryDirection =
                itemDirection == android.support.smv7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL;
    ...
    View findReferenceChild(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
        ...
        for (int i = start; i != end; i += diff) {
            ...
            if (position >= 0 && position < itemCount) {
                ...
                if (((android.support.smv7.widget.RecyclerView.LayoutParams) view.getLayoutParams()).isItemRemoved()) {
    ...
    private int getSpanGroupIndex(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
                                  int viewPosition) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanIndex(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    private int getSpanSize(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state, int pos) {
        if (!state.isPreLayout()) {
    ...
    void layoutChunk(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state,
                     android.support.smv7.widget.LinearLayoutManager.LayoutState layoutState, android.support.smv7.widget.LinearLayoutManager.LayoutChunkResult result) {
        ...
        final boolean layingOutInPrimaryDirection =
                layoutState.mItemDirection == android.support.smv7.widget.LinearLayoutManager.LayoutState.ITEM_DIRECTION_TAIL;
        int count = 0;
        ...
        for (int i = 0; i < count; i ++) {
            ...
            if (mOrientationHelper.getDecoratedMeasurement(view) != maxSize) {
                ...
                final int hSpec;
                if (mOrientation == android.support.smv7.widget.LinearLayoutManager.VERTICAL) {
                    wSpec = android.support.smv7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(totalSpaceInOther, View.MeasureSpec.EXACTLY,
                    ...
                    wSpec = View.MeasureSpec.makeMeasureSpec(maxSize - horizontalInsets,
                            View.MeasureSpec.EXACTLY);
                    hSpec = android.support.smv7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(totalSpaceInOther, View.MeasureSpec.EXACTLY,
        ...
        if (mOrientation == android.support.smv7.widget.LinearLayoutManager.VERTICAL) {
            if (layoutState.mLayoutDirection == android.support.smv7.widget.LinearLayoutManager.LayoutState.LAYOUT_START) {
    ...
    private void measureChild(View view, int otherDirParentSpecMode, boolean alreadyMeasured) {
        ...
        final int hSpec;
        if (mOrientation == android.support.smv7.widget.LinearLayoutManager.VERTICAL) {
            wSpec = android.support.smv7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(availableSpaceInOther, otherDirParentSpecMode,
                    horizontalInsets, lp.width, false);
            hSpec = android.support.smv7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(mOrientationHelper.getTotalSpace(), getHeightMode(),
                    verticalInsets, lp.height, true);
        } else {
            hSpec = android.support.smv7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(availableSpaceInOther, otherDirParentSpecMode,
                    verticalInsets, lp.height, false);
            wSpec = android.support.smv7.widget.RecyclerView.LayoutManager.getChildMeasureSpec(mOrientationHelper.getTotalSpace(), getWidthMode(),
    ...
    private void measureChildWithDecorationsAndMargin(View child, int widthSpec, int heightSpec,
        ...
        android.support.smv7.widget.RecyclerView.LayoutParams lp = (android.support.smv7.widget.RecyclerView.LayoutParams) child.getLayoutParams();
    ...
    private void assignSpans(android.support.smv7.widget.RecyclerView.Recycler recycler, android.support.smv7.widget.RecyclerView.State state, int count,
    ...
    public View onFocusSearchFailed(View focused, int focusDirection,
        ...
        final boolean ascend = (layoutDir == android.support.smv7.widget.LinearLayoutManager.LayoutState.LAYOUT_END) != mShouldReverseLayout;
        ...
        final boolean preferLastSpan = mOrientation == android.support.smv7.widget.LinearLayoutManager.VERTICAL && isLayoutRTL();
     ...
     */
    public static class LayoutParams extends android.support.smv7.widget.RecyclerView.LayoutParams {
        ...
        public LayoutParams(android.support.smv7.widget.RecyclerView.LayoutParams source) {
            super(source);
        }
