...
public class RecyclerViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    final android.support.smv7.widget.RecyclerView mRecyclerView;


    public RecyclerViewAccessibilityDelegate(android.support.smv7.widget.RecyclerView recyclerView) {
    ...
    public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
        ...
        info.setClassName(android.support.smv7.widget.RecyclerView.class.getName());
        if (!shouldIgnore() && mRecyclerView.getLayoutManager() != null) {
    ...
    public void onInitializeAccessibilityEvent(View host, AccessibilityEvent event) {
        ...
        event.setClassName(android.support.smv7.widget.RecyclerView.class.getName());
        if (host instanceof android.support.smv7.widget.RecyclerView && !shouldIgnore()) {
            android.support.smv7.widget.RecyclerView rv = (RecyclerView) host;
