...
import android.support.smv7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider;
...
public abstract class SnapHelper extends RecyclerView.OnFlingListener {
     ...
     *                          {@link RecyclerView}.
     *
     * @return a {@link android.support.smv7.widget.LinearSmoothScroller} which will handle the scrolling.
     */
    @Nullable
    private android.support.smv7.widget.LinearSmoothScroller createSnapScroller(RecyclerView.LayoutManager layoutManager) {
        if (!(layoutManager instanceof ScrollVectorProvider)) {
            return null;
        }
